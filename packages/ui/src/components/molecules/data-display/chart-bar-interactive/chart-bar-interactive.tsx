...
export type ChartBarInteractiveProps = {
   ...
   * Dados do gráfico
   */
  data?: ChartBarInteractiveDataPoint[];
  /**
  ...
  description?: string;
  /**
   * Gráfico ativo inicial
   * @default "desktop"
   */
  defaultActiveChart?: "desktop" | "mobile";
  /**
   * Altura do gráfico
   * @default "250px"
   */
...
const defaultChartData: ChartBarInteractiveDataPoint[] = [
...
export function ChartBarInteractive({
  ...
  const [activeChart, setActiveChart] = React.useState<"desktop" | "mobile">(defaultActiveChart);
...
ChartBarInteractive.displayName = "ChartBarInteractive";
