 ...
 * A posição precisa ser derivada da posição de origem + delta, nunca da posição
 * atual — senão o deslocamento acumula a cada evento e o widget dispara pra fora.
 */
