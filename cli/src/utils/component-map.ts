...
export const COMPONENT_MAP: Record<string, ComponentInfo> = {
  ...
  button: {
    name: "button",
    type: "atom",
    path: "packages/ui/src/components/atoms/actions/button",
  ...
  badge: {
    name: "badge",
    type: "atom",
    path: "packages/ui/src/components/atoms/actions/badge",
  ...
  input: {
    name: "input",
    type: "atom",
    path: "packages/ui/src/components/atoms/forms/input",
  ...
  card: {
    name: "card",
    type: "atom",
    path: "packages/ui/src/components/atoms/display/card",
  ...
  checkbox: {
    name: "checkbox",
    type: "atom",
    path: "packages/ui/src/components/atoms/forms/checkbox",
  ...
  skeleton: {
    name: "skeleton",
    type: "atom",
    path: "packages/ui/src/components/atoms/display/skeleton",
  ...
  table: {
    name: "table",
    type: "atom",
    path: "packages/ui/src/components/atoms/display/table",
  ...
  tabs: {
    name: "tabs",
    type: "atom",
    path: "packages/ui/src/components/atoms/navigation/tabs",
  ...
  alert: {
    name: "alert",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/alert",
  ...
  "alert-dialog": {
    name: "alert-dialog",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/alert-dialog",
  ...
  dialog: {
    name: "dialog",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/dialog",
  ...
  "dropdown-menu": {
    name: "dropdown-menu",
    type: "atom",
    path: "packages/ui/src/components/atoms/actions/dropdown-menu",
  ...
  sonner: {
    name: "sonner",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/sonner",
  ...
  tooltip: {
    name: "tooltip",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/tooltip",
  ...
  command: {
    name: "command",
    type: "atom",
    path: "packages/ui/src/components/atoms/navigation/command",
  ...
  collapsible: {
    name: "collapsible",
    type: "atom",
    path: "packages/ui/src/components/atoms/layout/collapsible",
  ...
  "scroll-area": {
    name: "scroll-area",
    type: "atom",
    path: "packages/ui/src/components/atoms/layout/scroll-area",
  ...
  "hover-card": {
    name: "hover-card",
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/hover-card",
  ...
  separator: {
    name: "separator",
    type: "atom",
    path: "packages/ui/src/components/atoms/display/separator",
  ...
  loader: {
    name: "loader",
    type: "atom",
    path: "packages/ui/src/components/atoms/animation/loader",
  ...
  shimmer: {
    name: "shimmer",
    type: "atom",
    path: "packages/ui/src/components/atoms/animation/shimmer",
  ...
  "inline-citation": {
    ...
    type: "atom",
    path: "packages/ui/src/components/atoms/feedback/inline-citation",
  ...
  "date-input": {
    name: "date-input",
    type: "atom",
    path: "packages/ui/src/components/atoms/forms/date-input",
    files: ["date-input.tsx", "index.ts"],
    dependencies: ["clsx", "tailwind-merge"],
  },
  "time-input": {
    name: "time-input",
    type: "atom",
    path: "packages/ui/src/components/atoms/forms/time-input",
    files: ["time-input.tsx", "index.ts"],
    dependencies: ["clsx", "tailwind-merge"],
  },
  slider: {
    name: "slider",
  ...
  "button-group": {
    name: "button-group",
    type: "molecule",
    path: "packages/ui/src/components/molecules/forms/button-group",
  ...
  "password-input": {
    name: "password-input",
    type: "molecule",
    path: "packages/ui/src/components/molecules/auth/password-input",
  ...
  "image-dropzone": {
    name: "image-dropzone",
    type: "molecule",
    path: "packages/ui/src/components/molecules/forms/image-dropzone",
  ...
  "stat-card": {
    name: "stat-card",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/stat-card",
  ...
  "menu-dock": {
    name: "menu-dock",
    type: "molecule",
    path: "packages/ui/src/components/molecules/navigation/menu-dock",
  ...
  "social-login-buttons": {
    ...
    type: "molecule",
    path: "packages/ui/src/components/molecules/auth/social-login-buttons",
  ...
  "calendar-popover": {
    ...
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/calendar-popover",
    files: ["calendar-popover.tsx", "index.ts"],
    dependencies: ["date-fns", "lucide-react", "clsx", "tailwind-merge"],
  },
  "calendar-range": {
    name: "calendar-range",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/calendar-range",
    files: ["calendar-range.tsx", "index.ts"],
    dependencies: ["date-fns", "react-day-picker", "lucide-react", "clsx", "tailwind-merge"],
  },
  "numeric-filter-field": {
    name: "numeric-filter-field",
    type: "molecule",
    path: "packages/ui/src/components/molecules/forms/numeric-filter-field",
    files: ["numeric-filter-field.tsx", "index.ts"],
    dependencies: ["react-number-format", "clsx", "tailwind-merge"],
  },
  "inline-datetime-editor": {
    name: "inline-datetime-editor",
    type: "molecule",
  ...
  artifact: {
    name: "artifact",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/artifact",
  ...
  message: {
    name: "message",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/message",
  ...
  suggestion: {
    name: "suggestion",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/suggestion",
  ...
  sources: {
    name: "sources",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/sources",
  ...
  tool: {
    name: "tool",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/tool",
  ...
  task: {
    name: "task",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/task",
  ...
  checkpoint: {
    name: "checkpoint",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/checkpoint",
  ...
  confirmation: {
    name: "confirmation",
    type: "molecule",
    path: "packages/ui/src/components/molecules/feedback/confirmation",
  ...
  connection: {
    name: "connection",
    type: "molecule",
    path: "packages/ui/src/components/molecules/flow/connection",
  ...
  canvas: {
    name: "canvas",
    type: "molecule",
    path: "packages/ui/src/components/molecules/flow/canvas",
  ...
  "widget-palette": {
    ...
    dependencies: ["@dnd-kit/core", "lucide-react", "clsx", "tailwind-merge"],
  },
  "widget-config-modal": {
    ...
    dependencies: ["@flowtomic/ui", "react-hook-form", "zod", "clsx", "tailwind-merge"],
  },
  "chat-message": {
    name: "chat-message",
    type: "molecule",
    path: "packages/ui/src/components/molecules/data-display/chat-message",
    files: ["chat-message.tsx", "index.ts"],
    dependencies: [
      "react-markdown",
      "lucide-react",
  ...
  "chat-log": {
    name: "chat-log",
    type: "organism",
    path: "packages/ui/src/components/organisms/chat-log",
    files: ["chat-log.tsx", "index.ts"],
    dependencies: ["use-stick-to-bottom", "lucide-react", "clsx", "tailwind-merge"],
  },
  "chat-input": {
    name: "chat-input",
    type: "molecule",
    path: "packages/ui/src/components/molecules/forms/chat-input",
    files: ["chat-input.tsx", "index.ts"],
    dependencies: ["lucide-react", "clsx", "tailwind-merge"],
  },
  "edit-chat-message-modal": {
    name: "edit-chat-message-modal",
    type: "molecule",
    path: "packages/ui/src/components/molecules/feedback/edit-chat-message-modal",
    files: ["edit-chat-message-modal.tsx", "index.ts"],
    dependencies: ["@radix-ui/react-dialog", "lucide-react", "clsx", "tailwind-merge"],
  },
};
